...
└── references/              # 分步进阶指南
    ...
    ├── step-1-5w2h.md       # 定义问题 (5W2H, 5-Why, Cynefin, 系统动力学)
    ├── step-2-scqa.md       # 确定目标 (A→B, SCQA, STAR, SMART, Pre-Mortem, 黄金圈, 费曼, 福格)
    ├── step-3-pyramid.md    # 搭建金字塔 (金字塔原理, 第一性原理, 奥卡姆剃刀, 归纳逻辑)
    ├── step-4-mece.md       # 横向分类 (MECE, MoSCoW/Kano, DDD/康威/通用语言, 80/20, Rule of 3, 艾森豪威尔)
